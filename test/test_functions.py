...
class TestOaiRecord(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        func = lambda x: OaiRecord(pickle.load(open(join(dirname(__file__), 'data', x))))
    ...
    def test_get_file_URL(self):
        ...
        self.assertListEqual(expected_result,
                             map(OaiRecord.get_file_URL, self.records))
    ...
    def test_retrieve_bare_ID(self):
        ...
        self.assertListEqual(expected_result,
                             map(OaiRecord.retrieve_bare_ID, self.records))

    def test_is_Trutat(self):
        """Test is_Trutat."""
        expected_result = [True, False]
        self.assertListEqual(expected_result,
                             map(OaiRecord.is_Trutat, self.records))
    ...
    def test_retrieve_ARK(self):
        ...
        self.assertListEqual(expected_result,
                             map(OaiRecord.retrieve_ARK, self.records))
    ...
    def test_retrieve_title(self):
        ...
        self.assertListEqual(expected_result,
                             map(OaiRecord.retrieve_title, self.records))
